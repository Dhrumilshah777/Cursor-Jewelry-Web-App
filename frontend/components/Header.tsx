  ...
  return (
    <header className="sticky top-0 left-0 right-0 z-50 w-full bg-white shadow-[0_1px_3px_rgba(0,0,0,0.06)]">
      ...
      <div className="md:hidden">
        ...
        {/* Sidebar panel */}
        <div
          className={`fixed left-0 top-0 z-50 h-full w-[min(100vw-4rem,20rem)] max-w-sm border-r border-border bg-card shadow-xl transition-transform duration-300 ease-out md:hidden ${
        ...
        >
          <div className="flex h-full flex-col px-4 pt-6 pb-6">
            <div className="mb-6 flex items-center justify-between">
              <span className="font-serif text-lg font-semibold text-text">Menu</span>
              <button
                type="button"
                onClick={() => setMobileOpen(false)}
