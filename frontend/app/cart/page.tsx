        ...
        {items.length === 0 ? (
          ...
          <>
            ...
            >
              ...
              <Link
                href={checkoutHref}
                className="flex min-h-[44px] min-w-0 flex-1 items-center justify-center gap-2 rounded-lg bg-text px-3 py-2.5 text-center text-[11px] font-semibold uppercase leading-tight tracking-wide text-white"
              >
