      ...
      <div className="mx-auto max-w-4xl">
        ...
        {items.length === 0 ? (
          <div className="mt-8 rounded border border-border bg-card p-8 text-center">
            <p className="text-text-muted">Add items from the Latest Beauty section by clicking the heart icon.</p>
            <Link
              href="/"
          ...
          <ul className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {items.map((product) => (
              <li
                key={product.id}
                className="group flex flex-col overflow-hidden rounded border border-border bg-card"
              >
                <Link href={productHref(product)} className="block flex-1">
                  ...
                  <div className="p-4">
                    <h2 className="font-sans text-sm font-semibold uppercase tracking-wide text-text">
                      {product.name}
                    </h2>
